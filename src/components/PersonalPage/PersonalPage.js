        ...
        <div className="section">
                    ...
                    <p className="App-personal-text-small">
                        <code>
                            ...
                            <code style={{marginTop: '35px', fontSize: '25px'}}>
                                ...
                                <code style={{fontSize: '18px', marginLeft: '30px'}}>
                                    i enjoy photos that are nostalgic and emotional, especially with contrasting
                                    colors. <p/>
                                </code>
                                <code style={{fontSize: '18px', marginLeft: '30px'}}>
                                    watching films that are emotionally impactful and inspire thought-provoking
                                    conversation. <p/>
                                </code>
                                <code style={{fontSize: '18px', marginLeft: '30px'}}>
            ...
            <div className="section">
                ...
                <div className="App-body-light-full">
                    ...
                    <p>
                        <code style={{fontSize: "25px"}}>more images will appear as I continue exploring the world
                            :)</code>
                    </p>
                </div>
            </div>
